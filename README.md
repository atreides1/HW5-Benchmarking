...
*Figure 2: Comparing GET, adjusted GET, and cutoff for 1ms response to see cap of sustained throughput* : ![alt text](https://github.com/atreides1/HW5-Benchmarking/blob/master/adj_and_avg_get1.png "Avg GET w AT")
